...
var netflix = {
    ...
    let e = netflix.season1.seasonInfo.episodeInfo[6].episodeName;
    let s = netflix.name;
     
    console.log("Episode Name;", netflix.season1.seasonInfo.episodeInfo[3].episodeName);
    console.log(`${e} is my favorite episode of ${s}`);
    ...
    console.log(Object.values(spaceJam.nbaPlayers));   //To get just the names (values) listed//
    console.log(Object.keys(spaceJam.nbaPlayers));       //To get just the Teams (keys) listed//
