...
function scope() { //Where something is in your code, how to find one specific area.
    var x = 33;
    console.log(x);
}
...
function varlet() {
  var y = 33
  if (true){
    let y = 45; //Starting to use "let" more than "var"
    console.log(y);
  }
  console.log(y);
}
...
function constTest() { //This is how 'Const' works
    const scope = 1;
    if (true) {
        const scope = 2;
        console.log(scope);
